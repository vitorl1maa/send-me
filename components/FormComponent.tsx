...
import { Eye, EyeClosed, PaperPlaneTilt, Spinner } from "@phosphor-icons/react";
          ...
          <div className="flex flex-col justify-center items-center h-full">
            ...
            <form className="flex flex-col gap-5 w-80" onSubmit={handleSubmit}>
              <Button
                ...
                className="flex w-full items-center hover:translate-y-2 gap-2 bg-transparent hover:bg-slate-300/30 transition text-textPrimary border border-neutral-800/20"
              >
                <Image
                  src="google (1).svg"
                  width={20}
